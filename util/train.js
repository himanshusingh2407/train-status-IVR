...
function getTrainID(trainNumber) {
  var response = api.callApi("https://api.railbeeps.com/api/searchTrains?trainno=" + trainNumber);
...
module.exports = {
  getTrainStatus: function(trainNumber, day) {
    ...
    var response = api.callApi("https://api.railbeeps.com/api/getRunningStatus/trainno/" + trainID + "/date/" + date.getDate(day));
